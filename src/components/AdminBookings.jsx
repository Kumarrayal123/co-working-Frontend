  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        // Filter bookings where cabin owner is admin
        const adminBookings = allBookings.filter(booking =>
          booking.cabinId?.owner === ADMIN_ID
        );
      ...
      <main className="pt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="admin-dash__header">
          <div>
            <h1 className="admin-dash__greeting">
              My Cabin <span>Bookings</span>
            </h1>
            <p className="admin-dash__subtitle">
              Bookings for your workspace cabins.
            </p>
          </div>
        ...
        {filteredBookings.length === 0 ? (
          <div className="admin-dash__error" style={{ background: '#f8fafc', borderColor: '#e2e8f0' }}>
            ...
            <p className="admin-dash__error-message">We couldn't find any bookings for your cabins.</p>
            {(searchTerm || filterDate) && (
              <button
