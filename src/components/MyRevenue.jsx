      ...
      <div className="pt-24 px-3 sm:px-4 md:px-6 lg:px-8 max-w-full mx-auto pb-16">
          ...
          <div className="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <div className="px-2 py-0.5 bg-white/20 backdrop-blur-sm rounded-full text-[8px] font-bold text-white uppercase tracking-wider">✦ Space</div>
              ...
              <p className="text-white/80 text-sm">Track and analyze your space earnings in real-time</p>
            </div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button onClick={() => navigate("/cabinbookings")} className="flex items-center gap-1.5 px-4 py-2 bg-white text-indigo-600 rounded-xl text-xs font-semibold hover:shadow-lg transition-all hover:scale-105">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
          ...
          <div className="bg-gradient-to-br from-indigo-50 via-indigo-100/50 to-indigo-200/30 rounded-xl border border-indigo-200 p-3 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300 group">
            ...
            <div className="text-[8px] text-indigo-500/70">Total space bookings</div>
          </div>
              ...
              <table className="w-full min-w-[900px] text-left">
                <thead>
                  <tr className="border-b border-gray-200" style={{ backgroundColor: '#f1f5f9' }}>
                    ...
                    <th className="px-3 py-2.5 text-[9px] font-bold tracking-wider text-gray-500 uppercase">Space</th>
                ...
                <tbody className="divide-y divide-gray-100">
                  {displayBookings.length === 0 ? (
                    <tr><td colSpan={8} className="px-3 py-12 text-center text-gray-400"><Receipt size={32} className="mx-auto mb-2 opacity-20" /><p className="text-sm font-medium">No space bookings found</p><p className="text-xs text-gray-400">Only space bookings are shown here</p></td></tr>
                  ) : (
