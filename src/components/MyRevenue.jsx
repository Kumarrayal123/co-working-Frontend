// MyRevenue.jsx - Complete with same UI as DoctorCabinRevenue
// Co-Working Space Revenue Tracking
...
const MyRevenue = () => {
  ...
  const calculateStats = (data) => {
    // ✅ FILTER ONLY CO-WORKING SPACE BOOKINGS (isChamber === false or null)
  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        // ✅ ONLY CO-WORKING CABINS (isChamber === false or null)
  ...
  const exportToExcel = () => {
    try {
      ...
      // ✅ ONLY CO-WORKING SPACE BOOKINGS
      ...
      XLSX.utils.book_append_sheet(wb, ws, 'Co_Working_Revenue');
      XLSX.writeFile(wb, `coworking_revenue_${new Date().toISOString().split('T')[0]}.xlsx`);
  ...
  // Get only co-working bookings for display
      ...
      <div className="pt-24 px-3 sm:px-4 md:px-6 lg:px-8 max-w-full mx-auto pb-16">
        ...
        <div className="flex justify-between items-center mb-5">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">
              Co-Working <span className="text-indigo-600">Revenue</span>
            </h1>
            <p className="text-sm text-gray-500">Track and analyze your co-working space earnings</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => navigate("/cabinbookings")}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 mb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-3 shadow-sm">
            ...
            <div className="text-[8px] text-gray-400">Total co-working bookings</div>
          </div>
        ...
        {viewMode === "table" && (
          <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                  ...
                  {displayBookings.length === 0 ? (
                    <tr>
                      <td colSpan={8} className="px-3 py-12 text-center text-gray-400">
                        ...
                        <p className="text-sm font-medium">No co-working bookings found</p>
                        <p className="text-xs text-gray-400">Only co-working space bookings are shown here</p>
                      </td>
                    </tr>
                  ) : (
                        ...
                        <tr key={b._id} className="transition-colors hover:bg-gray-50/80">
                          ...
                          <td className="px-3 py-2.5">
                            <div>
                              ...
                              <span className="text-[8px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded-full font-medium">Co-Working</span>
                            </div>
                          </td>
                          <td className="px-3 py-2.5">
            ...
            <div className="px-3 py-2 border-t border-gray-100 bg-gray-50/50 flex justify-between text-[9px] text-gray-500">
              <span>Showing {displayBookings.length} co-working bookings</span>
