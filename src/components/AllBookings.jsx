        ...
        <div class="invoice-wrapper">
          <div class="header">
            ...
            <div class="header-right">
              ...
              <div class="invoice-date">${formatDateIndian(new Date().toISOString())}</div>
            </div>
          </div>
          ...
          <div class="info-grid">
            <div class="info-item">
              ...
              <div class="value">${formatDateIndian(booking.startDate || booking.date)}</div>
              <div class="sub-value" style="color:#000000;font-weight:600;">${formatTime12(booking.startTime || booking.time)}</div>
            </div>
            <div class="info-item">
              <div class="label">End</div>
              <div class="value">${formatDateIndian(booking.endDate || booking.startDate)}</div>
                          ...
                          <>
                            ...
                            <td className="px-3 py-2 text-center">
                              <div className="flex items-center justify-center gap-1">
                                <button 
                                  onClick={() => handleViewBooking(booking)} 
                                  className="p-1.5 bg-indigo-50 text-indigo-700 rounded-lg hover:bg-indigo-100 transition" title="View Details"
                                >
                                  <Eye size={13} />
                                </button>
                                <button 
                            ...
                            <td className="px-3 py-2">
                              <div className="flex items-center justify-center gap-1 flex-wrap">
                                ...
                                <button 
                                  ...
                                  className="p-1.5 bg-emerald-50 text-emerald-700 rounded-lg hover:bg-emerald-100 transition" title="Download Invoice"
                                >
                                  <Receipt size={13} />
                                </button>
                                <button 
        ...
        <div className="fixed inset-0 z-[1200] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={(e) => { if (e.target === e.currentTarget) setShowViewModal(false); }}>
          <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-2">
                {viewBooking.bookingType !== 'visit' && (
                  <button onClick={() => { setShowViewModal(false); downloadInvoice(viewBooking); }} className="flex-1 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition shadow-sm active:scale-[0.98] flex items-center justify-center gap-2">
